...
| 1.0.0 | Стабильный релиз: формат зафиксирован, фикстуры вычищены, `just check` и `cargo package` проходят |

## План

### После 1.0.0

- Поддерживать обратную совместимость форматирования и исправлять ограничения из списка known issues.
